...
async def select_format(_, query, obj):
    ...
    if data[1] == "dict":
        ...
        await edit_message(message, "ᴛᴀsᴋ ɪs ᴄᴀɴᴄᴇʟʟᴇᴅ.")
        obj.qual = None
...
class YtSelection:
    ...
    async def _event_handler(self):
        ...
        try:
            ...
            await edit_message(self._reply_to, "ᴛɪᴍᴇ ᴏᴜᴛ ʙᴄ..!")
            self.qual = None
    ...
    async def get_quality(self, result):
        ...
        if "entries" in result:
            ...
            buttons.data_button("🎵 ᴍᴘ3", "ytq mp3")
            buttons.data_button("🥂 ᴀᴜᴅɪᴏ ғᴏʀᴍᴀᴛ", "ytq audio")
            buttons.data_button("💀 ʙᴇsᴛ ᴠɪᴅᴇᴏs", "ytq bv*+ba/b")
            buttons.data_button("🧘 ʙᴇsᴛ ᴀᴜᴅɪᴏs", "ytq ba/b")
            buttons.data_button("🤕 ᴄᴀɴᴄᴇʟ", "ytq cancel", "footer")
            self._main_buttons = buttons.build_menu(3)
            msg = f"<b>ᴄʜᴏᴏsᴇ ᴠɪᴅᴇᴏ ǫᴜᴀʟɪᴛʏ:\n\nᴛɪᴍᴇᴏᴜᴛ</b>: {get_readable_time(self._timeout - (time() - self._time))}"
        else:
    ...
    async def qual_subbuttons(self, b_name):
        ...
        buttons.data_button("ʙᴀᴄᴋ", "ytq back", "footer")
        buttons.data_button("ᴄᴀɴᴄᴇʟ", "ytq cancel", "footer")
